...
class Hemocentro: CentroDeDoaçãoLPS {
    ...
    override init(key: String = "",nomeCentroDoação: String, nomeCentroDoação2: String, cidade: String, endereço: String, cep: String, telefone: String, email: String, horario: String, necessidade: String) {
